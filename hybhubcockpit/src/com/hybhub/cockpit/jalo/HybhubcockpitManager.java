 ...
 */
package com.hybhub.cockpit.jalo;
...
import com.hybhub.cockpit.constants.HybhubcockpitConstants;


/**
 * This is the extension manager of the hybhubcockpit extension.
 */
public class HybhubcockpitManager extends GeneratedHybhubcockpitManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger(HybhubcockpitManager.class.getName());
	 ...
	 */
	public static final HybhubcockpitManager getInstance()
	{
		return (HybhubcockpitManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(HybhubcockpitConstants.EXTENSIONNAME);
	}
