 ...
 */
package com.hybhub.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(HybhubFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(HybhubFulfilmentProcessConstants.PARENT_PROCESS);
