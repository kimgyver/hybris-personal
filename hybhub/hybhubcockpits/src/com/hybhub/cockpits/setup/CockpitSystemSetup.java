 ...
 */
package com.hybhub.cockpits.setup;
...
import com.hybhub.cockpits.constants.HybhubCockpitsConstants;
 ...
 */
@SystemSetup(extension = HybhubCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(HybhubCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(HybhubCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						HybhubCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/hybhubcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
