...
import com.hybhub.test.constants.HybhubTestConstants;
import com.hybhub.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = HybhubTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/hybhubtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/hybhubtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/hybhubtest/import/cstickets.impex");
			...
			importImpexFile(context, "/hybhubtest/import/csquotes.impex");
		}
	}
}
